export const logoEmpresa = {
  ...
  steps: [
    {
      title: '1. Elabora un brief para el diseño de tu logo',
      color: '#323c9e',
      icon: '/icons/creative-process-1.svg',
      description: 'Completa unas simples preguntas para ayudar a los diseñadores a conocer sobre tu actividad, clientes, competidores, diferenciación y tus preferencias de diseño.',
      alt: 'brief-y-selector'
    },
    {
      title: '2. Creamos y perfeccionamientos conceptos ilimitados.',
      color: '#1d8127',
      icon: '/icons/creative-process-2.svg',
      description: 'Diseñamos conceptos originales y los perfeccionamos hasta que estés 100% conforme.',
      alt: 'conceptos'
    },
    {
      title: '3. Descarga tu logo listo para utilizar',
      color: '#c3953f',
      icon: '/icons/creative-process-3.svg',
      description: 'Dispone de tu logo en gran variedad de formatos y aplícalo donde sea que lo necesites.',
