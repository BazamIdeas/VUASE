export const tripticos = {
  ...
  /* ** */
  title: 'Tríptico',
  list: ['Creamos tus diseños 100% únicos y exclusivos', 'Todas las creatividades realizadas a medida y ¡de forma ilimitada!', 'Vas a tener los diseños en 24 horas', 'Tu folleto o tríptico en formato digital preparado para poder hacer uso de él de forma digital o impreso'],
  ...
  carousel: {
    items1: [
      { img: '/images/services-carousel/tripticos/Mockup Odpicya_compressed.jpg' },
      { img: '/images/services-carousel/tripticos/mockup visiohealth_compressed.jpg' },
      { img: '/images/services-carousel/tripticos/Mockup andres mora_compressed.jpg' },
      { img: '/images/services-carousel/tripticos/mockup archie_compressed.jpg' },
      { img: '/images/services-carousel/tripticos/Mockup macrobit_compressed.jpg' },
      { img: '/images/services-carousel/tripticos/mockup waave_compressed.jpg' }
    ]
  },
  packs: {
