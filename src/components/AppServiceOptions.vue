        ...
        <v-flex class="ml-2">
            ...
            <div v-if="existSelecteds()">
              ...
              <v-layout xs12 row d-flex class="mt-2">
                <v-flex xs4>
                  <h2 style="color:#F7941F;" class="display-1 font-weight-medium"  :style="'color:'">{{price.currency.symbol}} {{price.value}}</h2>
                </v-flex>
              ...
              <v-btn :style="'background:' + color" dark class="mt-3 ml-0" >INICIAR MI PROYECTO</v-btn>
            </div>         
  ...
  export default {
    ...
    methods: {
      ...
      selectOptionItem (index, slug) {
        ...
        let selectedsString = JSON.stringify(this.selecteds)
