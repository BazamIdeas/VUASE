  ...
  <section>
    ...
    <v-container grid-list-md class="mt-3 pb-0">
      <v-layout row wrap>
        ...
        <AppServiceOptions v-if="dataService.serviceOptions" :img="dataService.serviceOptions.img" :color="dataService.serviceOptions.color" :addons="addons" :price="service.price"/>
        <!-- PACKS -->
