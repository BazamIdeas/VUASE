<template>
  <section>
    ...
    <!-- CAROUSEL -->
    <AppHeading :number="'2'" v-if="dataService.carousel && dataService.carousel.items1" :size="'display-1'" title="Estilos y diseños adaptados a tus necesidades" class="mb-5" />
